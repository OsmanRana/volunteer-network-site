    ...
    return (
        <div className="container my-5">
            ...
            <div className=" shadow my-5 text-center p-5 login-box border rounded-3">
                ...
                <span onClick={handleGoogleSignIn} className="p-3 m-3 border rounded-pill d-block btn"><img className="img-fluid" src="./google.png" alt=""/>Continue with Google</span>
